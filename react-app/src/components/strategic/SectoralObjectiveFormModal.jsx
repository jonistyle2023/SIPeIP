...
export default function SectoralObjectiveFormModal({planSectorialId, onClose, onSave}) {
    ...
    return (
        <div className="fixed inset-0 bg-white/30 backdrop-blur-sm flex justify-center items-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-lg">
                <h2 className="text-lg font-bold mb-4">Añadir Objetivo Sectorial</h2>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="mt-6 flex justify-end space-x-3">
                        ...
                        <button type="submit" disabled={isSaving}
                                className="px-4 py-2 bg-blue-600 text-white rounded-md disabled:bg-blue-300">{isSaving ? 'Guardando...' : 'Guardar Objetivo'}</button>
                    </div>
                </form>
            </div>
        </div>
