        ...
        <div className="fixed inset-0 bg-white/30 backdrop-blur-sm flex justify-center items-center z-50">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-lg">
                <div className="p-4 border-b flex justify-between items-center"><h3
                    className="text-lg font-semibold">{period ? 'Editar Período' : 'Nuevo Período'}</h3>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="p-6 space-y-4">
                        ...
                        <div><label className="text-sm">Fecha de Inicio</label><input type="date" name="fecha_inicio"
                                                                                      value={formData.fecha_inicio}
                                                                                      onChange={handleChange}
                                                                                      className="w-full p-2 border rounded"
                                                                                      required/></div>
                        <div><label className="text-sm">Fecha de Fin</label><input type="date" name="fecha_fin"
                        ...
                        <label className="flex items-center space-x-2"><input type="checkbox"
                                                                              name="es_activo_para_carga"
                                                                              checked={formData.es_activo_para_carga}
                                                                              onChange={handleChange}/><span>Activo para carga de información</span></label>
                    </div>
