            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-lg">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="p-6 space-y-4">
                        ...
                        <select name="nivel_gobierno" value={formData.nivel_gobierno} onChange={handleChange} className="w-full p-2 border rounded" required>
                            <option value="">Seleccione Nivel de Gobierno</option>
                            {nivelesGobierno.map(n => <option key={n.id} value={n.id}>{n.nombre}</option>)}
                        </select>
                        <select name="sector" value={formData.sector} onChange={handleChange} className="w-full p-2 border rounded">
