    ...
    return (
        <div className="space-y-6">
            <div className="p-4 border rounded-lg dark:border-slate-700">
                <h3 className="font-semibold text-lg mb-2 dark:text-white">1. Vinculación del Proyecto con el Programa
                    Institucional</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="md:col-span-2">
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Seleccionar Programa</label>
                        <select
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Contribución al Programa (%)</label>
                        <input
                            type="number"
                            value={contribucion}
            ...
            {loading && <p className="dark:text-gray-300">Cargando cadena de alineación...</p>}
            {alignmentChain && (
                <div className="p-4 border rounded-lg bg-gray-50 dark:bg-slate-800 dark:border-slate-700">
                    <h3 className="font-semibold text-lg mb-3 dark:text-white">2. Cadena de Alineación Estratégica (Automática)</h3>
                    <div className="space-y-3 text-sm dark:text-gray-300">
                        ...
                        <div className="pl-5 border-l-2 ml-2 dark:border-slate-600"><p className="flex items-start"><Layers size={18}
                        ...
                        <div className="pl-12 border-l-2 ml-2 dark:border-slate-600"><p className="flex items-start"><i
                        ...
                        <div className="pl-20 border-l-2 ml-2 dark:border-slate-600"><p className="flex items-start"><Flag size={18}
