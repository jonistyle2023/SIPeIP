    ...
    return (
        <div className="fixed inset-0 bg-white/30 backdrop-blur-sm flex justify-center items-center z-80">
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-xl w-full max-w-lg border dark:border-slate-700">
                <h2 className="text-lg font-bold mb-4 dark:text-white">{ods ? 'Editar Objetivo de Desarrollo Sostenible' : 'Crear Nuevo Objetivo de Desarrollo Sostenible'}</h2>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Nombre del ODS</label>
