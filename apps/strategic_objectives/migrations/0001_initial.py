    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField()),
                ('icono', models.CharField(blank=True, help_text='Ruta al archivo del ícono SVG', max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='IndicadorODS',
            fields=[
                ('indicador_ods_id', models.AutoField(primary_key=True, serialize=False)),
                ('codigo', models.CharField(max_length=50)),
                ('descripcion', models.TextField()),
                ('meta_ods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='indicadores', to='strategic_objectives.metaods')),
            ],
        ),
        migrations.CreateModel(
            name='IndicadorPND',
        ...
        migrations.AddField(
            model_name='metaods',
            name='ods',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='metas', to='strategic_objectives.objetivodesarrollosostenible'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ods_vinculados', models.ManyToManyField(blank=True, related_name='alineaciones', to='strategic_objectives.objetivodesarrollosostenible')),
            ],
            options={
