...
class ObjetivoPNDSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ObjetivoPND
        fields = ['objetivo_pnd_id', 'pnd', 'codigo', 'descripcion', 'politicas']
...
class ObjetivoDesarrolloSostenibleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['ods_id', 'numero', 'nombre', 'descripcion', 'estrategias']
...
class PlanSectorialSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PlanSectorial
        fields = ['plan_sectorial_id', 'nombre', 'periodo', 'entidad_responsable', 'fecha_publicacion', 'objetivos']
