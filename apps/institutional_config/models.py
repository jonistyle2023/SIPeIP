...
# Resuelve: "Gestión de Catálogos y Datos Maestros" (tipos de intervención, sectores, etc.)
...
# Modelo para Entidades
# Resuelve: "Gestión de Entidades y Unidades Organizacionales"
class Entidad(models.Model):
    nombre = models.CharField(max_length=255, unique=True)
    codigo_unico = models.CharField(max_length=50, unique=True, help_text="Código único de creación de la entidad")

    # CAMPO AÑADIDO PARA CUMPLIR CRITERIO 1
...
# Modelo para Unidades Organizacionales (Jerarquía dentro de una Entidad)
class UnidadOrganizacional(models.Model):
    ...
    # Campo para crear jerarquías (ej. una Dirección que depende de una Subsecretaría)
...
# Modelo para los Períodos de Planificación
# Resuelve: "Gestión de Períodos"
class PeriodoPlanificacion(models.Model):
    ...
    # Podríamos tener solo un período activo para la carga de nueva información
