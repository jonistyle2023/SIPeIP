...
INSTALLED_APPS = [
    ...
    'apps.authentication',
    'apps.institutional_config',
    'apps.strategic_objectives',
...
REST_FRAMEWORK = {
    ...
    'URL_FORMAT_OVERRIDE': None, # Esto Evita que DRF trate de resolver URLs con extensión. (Batalle mucho con esto)
